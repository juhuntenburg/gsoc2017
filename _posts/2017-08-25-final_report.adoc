...
* Making software design choices (blog: <<../../../_posts/2017-05-11-Wisdom-of-the-crowd.adoc#, Wisdom of the crowd>>, <<../../07/28/Nighres.html#, Nighres>>, <<../../08/11/Documentation.html#, Documentation>>)
...
** Creating a documentation with Sphinx and writing in ReStructuredText(blog: <<../../../_posts/2017-08-11-Documentation.adoc#sphinx, Sphinx>>, code:  https://github.com/nighres/nighres/tree/master/doc[doc])
